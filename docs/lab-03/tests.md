...
| E2E (Playwright) | `cd .. && pnpm test:e2e:lab3` (root `package.json`; desktop-project only, `workers: 1` from `playwright.config.ts`; needs both servers running) | **Pass** — E2E-01..05 5/5 desktop + 10 viewport skips (2026-09-26, after the PR #73 post-review fixes; original close-out 2026-09-24); legacy `e2e/lab-02` specs skipped (45). RESP-01..24 stay `Planned` — owned by Issue 23 |
