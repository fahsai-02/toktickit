...
|-------|---------|--------|
| Server (unit + API) | `cd server && pnpm test` | **Pass** — 20 files / 285 tests (2026-09-22) *(API-34..55, API-73..75, UNIT-03 from Issue 20; API-60..72 + API-18 from Issue 21 `feature/21-admin-user-management`; reseed before run)* |
| Client (component + style) | `cd client && pnpm test` | **Pass** — 17 files / 189 tests (2026-09-22) *(incl. UI-11..13 `StaffTicketDetail` and UI-14..16 `UserManagement` suites from Issues 20/21)* |
